                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        {{--  
                            ...
                            Hiện thị khi người dùng chưa đăng nhập. 
                        ...
                        {{-- 
                            ...
                            Hiển thị sau khi người dùng đăng nhập với quyền người tuyển dụng    
                            ...
                            <div class="jp_header_form_wrapper">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                    <div class="jp_form_btn_wrapper">
                                        <ul>
                                        <li><a href="{{route('job')}}"><i class="fa fa-search"></i> Search</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="item">
                                            <div class="jp_hiring_content_main_wrapper">
                                                <div class="jp_hiring_content_wrapper">
                                                    ...
                                                    <p>(NewYork)</p>
                                                    <ul>
                                                    <li><a href="/companies/{{1}}">4 Opening</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
