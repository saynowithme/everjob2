                        ...
                        <div class="white-box">
                            ...
                            <div class="user-btm-box">
                                <div class="col-md-6 col-sm-6 text-center">
                                    <p class="text-purple"><i class="fa fa-pencil fa-fw"></i> Số bài đăng</p>
                                    <h3>{{ $profile->posts->count('name')}}</h3>
                                </div>
                                <div class="col-md-6 col-sm-6 text-center">
                                    <p class="text-danger"><i class="fa fa-clock-o" aria-hidden="true"></i></i> Ngày kích hoạt</p>
                                    <h3>{{$profile->created_at->diffForHumans()}}</h3> 
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="tab-pane fade" id="posts">
                            	...
                            	<div class="list-group">
                                 @foreach($profile->posts as $post)
                                        <a href="post/{{$post->slug}}.html"><p><i class="fa fa-arrow-circle-right"></i> {{$post->title}} </p></a>
